<template lang="html">
  <div class="ct">
    ...
    <div class="main">
      ...
      <div class="box">
        <img src="../assets/images/login/wy.jpg" class='wy' @click='tourl("/modey",{type:"white"})'>
        <!-- <img src="../assets/images/login/wx.jpg" class='wx' @click='tourl("/modex",{type:"white"})'> -->
        <img src="../assets/images/login/by.jpg" class='wx' @click='tourl("/modey",{type:"black"})'>
        <!-- <img src="../assets/images/login/bx.jpg" class='bx' @click='tourl("/modex",{type:"black"})'> -->
      </div>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            tourl(url, query) {
                ...
                this.unitAjax('post', 'v1/me/themeSetting', {
                        theme: url
                    }, res => {
                        if (res.code == 200) {
                            tools.router.push({
